...
shinyServer(function(input, output) {
  ...
  ####datafile2 <- read.csv("final_motor_merged.csv", fileEncoding = "iso-8859-1")
  ####datafile2 <- read.csv("final_motor_merged_cleaned.csv", fileEncoding = "iso-8859-1")
  datafile2 <- read.csv("final_cdi_merged_cleaned.csv", fileEncoding = "iso-8859-1")
